...
namespace Models
{
    public class DIE_FIN_EXTRATO_BB
    {
            [StringLength(100)]
        /// <summary>
        /// 
    ...
    [StringLength(1)]
        ...
        /// 
        /// </summary>
        public int DIE_FIN_EXTRATO_BB_ID { get; set; }
            [Required]
        /// <summary>
        /// 
        /// </summary>
