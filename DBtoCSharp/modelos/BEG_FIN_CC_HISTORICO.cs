...
namespace Models
{
    public class BEG_FIN_CC_HISTORICO
    {
    ...
    [StringLength(100)]
        ...
        /// 
        /// </summary>
        public string CAIXA_OBRIGATORIO { get; set; }
