...
namespace Models
{
    public class DIE_CARGA_DIARIO_CLI
    {
            [StringLength(1)]
        /// <summary>
        /// 
        ...
        public string CONFERIDO { get; set; }
            [StringLength(3)]
        /// <summary>
        /// Filial original do lancamento - cuidado - reaproveitamento de codigo filial
        /// </summary>
