...
describe("FileParser", function () {
    ...
    describe("classes:", function () {
        it("should be able to fetch classes inside namespaces", useCSharp('ClassInsideNamespace.cs', function (parser) {
            ...
            expect(file.namespaces[0].classes[0].attributes[1].parameters[2].value.name).toBe("Framework.Blah", "namespace class attribute parameter 2 value");
        }));
        it("should be able to fetch interfaces that implement something", useCSharp('ImplementedInterface.cs', function (parser) {
            var file = parser.parseFile();
    ...
    describe("generics:", function () {
        it("should be able to handle generics", useCSharp('Generics.cs', function (parser) {
            var file = parser.parseFile();
            expect(file.classes.length).toBe(1, "classes length");
    ...
    describe("methods:", function () {
        it("should be able to fetch methods inside classes and their parameters", useCSharp('MethodInsideClass.cs', function (parser) {
            ...
            var defaultValue = file.classes[0].methods[5].parameters[0].defaultValue;
    ...
    describe("interfaces:", function () {
        it("should be able to fetch interfaces inside namespaces", useCSharp('InterfaceInsideNamespace.cs', function (parser) {
            var file = parser.parseFile();
    ...
    describe("statics:", function () {
        it("should be able to detect statics", useCSharp('Static.cs', function (parser) {
            var file = parser.parseFile();
